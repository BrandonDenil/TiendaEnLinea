...
<nav >
  <div class="nav-wrapper black lighten-2 ">
    <a href="#" class="brand-logo" style="margin-left: 1em;">Store Online S.A  --> Gerente</a>

    <ul class="right hide-on-med-and-down">
      <?php
      // $_SESSION["id_usuario"]=$row["id"];
        session_start();
        if(isset( $_SESSION["sesion_sistema"] ))
        { 
          ...
          echo '<li><a href="cerrar_sesion.php">Cerrar Sesion y salir</a></li>';
           ...
           else if ($_SESSION["sesion_sistema"]==0 ||  $_SESSION["rol"]!="gerente" )
         {
